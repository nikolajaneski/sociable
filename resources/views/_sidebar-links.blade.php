<div class="bg-white border border-gray-300 rounded-lg pl-6 pt-4">
    <ul>
        <li><a 
            class="font-bold text-lg mb-4 block {{ request()->routeIs('posts') ? 'text-blue-500' : '' }}"
            href="{{ route('posts') }}"
        >Home</a></li>
        <li><a 
            class="font-bold text-lg mb-4 block  {{ request()->routeIs('explore') ? 'text-blue-500' : '' }}"
            href="{{ route('explore') }}"
        >Explore</a></li>
        <li>
            <a 
                class="flex font-bold text-lg mb-4 {{ request()->routeIs('notifications') ? 'text-blue-500' : '' }}"
